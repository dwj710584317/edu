...
<head>
    ...
    <link href="/admin/static/h-ui.admin/static/css/H-ui.login.css" rel="stylesheet" type="text/css"/>
    <link href="/admin/static/h-ui.admin/static/css/style.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <input class="input-text size-L" type="text" placeholder="验证码"
                           name="captcha" onblur="if(this.value==''){this.value='验证码:'}"
                           onclick="if(this.value=='验证码:'){this.value='';}" value="验证码:" style="width:150px;">
                    <img src="{{captcha_src('flat')}}}>"> <a id="kanbuq">看不清，换一张</a></div>
            </div>
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <label for="online">
                        {{--注意选中的话标签中的value值可以传递到服务器中--}}
